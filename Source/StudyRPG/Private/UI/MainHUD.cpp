...
void AMainHUD::DisplayInputNumberToDropWidget(UItemBase* FromItem, IInventoryOwnerInterface* FromOwner, UItemBase* ToItem, IInventoryOwnerInterface* ToOwner)
{
	InventoryMenuWidget->SetItemToChange(FromItem, FromOwner, ToItem, ToOwner);
}

void AMainHUD::DisplayInputNumberToSplitWidget(UItemBase* ItemToSplit, IInventoryOwnerInterface* ItemOwner)
{
	InventoryMenuWidget->SetItemToSplit(ItemToSplit, ItemOwner);
}
